...
describe("Documents reducer", () => {
  ...
  it('should handle LOAD_DOCS', () => {
    ...
    Reducer(documents).withState(state).expect(action).toReturnState(result);
  });
  ...
  it('should run actionHandlers based on doc type and action type to related documents', () => {
    ...
    expect(documents(state, action , {actionHandlers, getRelevantDocsIds})).toEqual(result);
  });
  ...
  it('should ignore actions not in actionHandlers', () => {
    ...
    expect(documents(state, action , {actionHandlers, getRelevantDocsIds})).toBe(result);
  });
